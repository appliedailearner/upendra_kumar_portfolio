...
$exclude = @('.git', '.github', '.venv', '.terraform', '.agent', 'node_modules', 'site_backups', '*.md', '*.py', '*.ps1', 'appliedailearner.github.io', 'azure-landing-zones-project', 'azure-projects', 'portfolio-deploy', 'portfolio-template', 'master prompts', 'azure-agentic-ai-architect-labs')
