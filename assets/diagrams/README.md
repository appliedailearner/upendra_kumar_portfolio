...
- `png_hi/` -> exported PNGs (some diagrams have multiple pages: `*-0.webp`, `*-1.webp`, ...)
...
- PNG: `png_hi/app-gateway-internal-api-management-function-*.webp`
...
- PNG: `png_hi/openai-end-to-end-basic-*.webp`
...
- PNG: `png_hi/baseline-microsoft-foundry-*.webp`
...
- PNG: `png_hi/baseline-microsoft-foundry-landing-zone-*.webp`
...
- PNG: `png_hi/baseline-landing-zone-networking-*.webp`
...
- PNG: `png_hi/baseline-landing-zone-networking-egress-*.webp`
...
- PNG: `png_hi/azure-openai-authentication-*.webp`

## Notes
- PNGs were produced by exporting VSDX -> PDF -> PNG in a headless Linux environment. Layout stays faithful to the Visio.
- If you need **a single PNG per diagram**, use the `*-0.webp` page in `png_hi/` (most diagrams are page 0).
